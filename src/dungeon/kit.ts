// Dark Fortress modules exported from the Synty source FBX with Blender
// (scripts/export-kit.py). Every piece is recentred on its footprint with its
// base at y = 0 (banner: top at y = 0) and its detailed face towards +Z.
// Sizes are glTF x / y / z in metres.
...
export const KIT = {
  ...
  skulls: { src: 'models/dungeon/skulls.gltf', size: [0.65, 0.39, 0.41], tris: 400 },
  ...
  rune: { src: 'models/dungeon/rune.gltf', size: [0.8, 0.6, 0.06], tris: 96 },
  ...
  banner: { src: 'models/dungeon/banner.gltf', size: [1.24, 3.86, 0.52], tris: 1442 },
  ...
  rubble: { src: 'models/dungeon/rubble.gltf', size: [2.38, 0.32, 1.59], tris: 470 },
  bones: { src: 'models/dungeon/bones.gltf', size: [0.67, 1.2, 0.84], tris: 246 },
